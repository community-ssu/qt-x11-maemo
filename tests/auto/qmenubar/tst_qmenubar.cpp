...
{
#if defined(Q_WS_MAC) || defined(Q_OS_WINCE_WM) || defined(Q_WS_MAEMO_5)
...
#endif
#ifdef Q_WS_MAEMO_5
    QSKIP("On Maemo 5, native key events are needed to test menu action activation", SkipAll);
#endif
    Menu menu;
#ifdef QT3_SUPPORT
    initComplexMenubar();
...
#endif
#ifdef Q_WS_MAEMO_5
    QSKIP("On Maemo 5, the menubar supports no menus", SkipAll);
#endif
    QMenuBar menubar;
    QMenu menu("menu1");
